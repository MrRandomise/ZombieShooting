...
namespace Logics
{
    public sealed class CharacterCanShootEvent : IEventLogics
    {
        ...
        public CharacterCanShootEvent(AtomicVariable<bool> canShoot, AtomicVariable<int> amoAmount, AtomicVariable<float> shootTimeout, AtomicEvent onFire, AtomicVariable<bool> isAlive)
        {
            _canShoot = canShoot;
